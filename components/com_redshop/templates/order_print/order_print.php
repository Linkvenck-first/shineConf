		...
		<tr>
			<td>
				<p style="text-align: right; color: #292a35;">
					<br />{order_subtotal_lbl}: {product_subtotal}<br /> <!-- {if discount}-->{discount_lbl} {order_discount} <br /> <!-- {discount end if}-->{shipping_lbl} {order_shipping} <br />{order_transfee_label} {order_transfee} <br /><strong><br />{total_lbl}: </strong><strong>{order_total_incl_transfee}</strong> <br /> <!-- {if vat} -->{vat_lbl}: {order_tax} <!-- {vat end if} -->
				</p>
			</td>
		</tr>
	</tbody>
